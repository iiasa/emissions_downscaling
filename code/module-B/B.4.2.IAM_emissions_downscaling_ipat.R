...
iam_em <- readData( domain = 'MED_OUT', file_name = paste0( 'B.', iam_name, '_emissions_ipat' ) )
ref_em <- readData( domain = 'MED_OUT', file_name = paste0( 'B.', ref_name, '_emissions_baseyear_ipat' ) )
pop_data <- readData( domain = 'MED_OUT', file_name = paste0( 'B.iiasa_pop_iso_', iam_name, '_region' ) )
gdp_data <- readData( domain = 'MED_OUT', file_name = paste0( 'B.iiasa_gdp_iso_', iam_name, '_region' ) )
...
out_filename <- paste0( 'B.', iam_name, '_emissions_downscaled_ipat' )
